...
export default function Header() {
  ...
  return (
    <>
      ...
      >
        <a ref={logoRef} href="#" className="text-xl md:text-2xl font-bold font-heading tracking-tight uppercase relative z-50">
          <span className="md:hidden">BF</span>
          <span className="hidden md:inline">BUILDFORGE</span>
        </a>
